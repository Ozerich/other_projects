...
<header class="width">
    ...
    <nav>
		<? if(Yii::app()->user->model()->type == 1 || $this->menu_baby): ?>
        <ul>
            <li <?=$this->active_tab == 'diary' ? 'class="active"' : ''?>><a href="/diary/<?=$this->menu_baby ? $this->menu_baby : ''?>"><img src="/images/img09.png" alt=""> <span>ДНЕВНИК</span></a></li>
            <li <?=$this->active_tab == 'gallery' ? 'class="active"' : ''?>><a href="/gallery/<?=$this->menu_baby ? $this->menu_baby : ''?>"><img src="/images/img1.png" alt=""> <span>ГАЛЕРЕЯ</span></a></li>
            <li <?=$this->active_tab == 'baby' ? 'class="active"' : ''?>><a href="/baby/<?=$this->menu_baby ? $this->menu_baby : ''?>"><img src="/images/img2.png" alt=""> <span>О МАЛЫШЕ</span></a></li>
            <li <?=$this->active_tab == 'growth' ? 'class="active"' : ''?>><a href="/weight/<?=$this->menu_baby ? $this->menu_baby : ''?>"><img src="/images/img3.png" alt=""> <span>РАЗВИТИЕ</span></a></li>
            <li <?=$this->active_tab == 'health' ? 'class="active"' : ''?>><a href="/medicine/<?=$this->menu_baby ? $this->menu_baby : ''?>"><img src="/images/img4.png" alt=""> <span>ЗДОРОВЬЕ</span></a></li>
            <li <?=$this->active_tab == 'calendar' ? 'class="active"' : ''?>><a href="/calendar/<?=$this->menu_baby ? $this->menu_baby : ''?>"><img src="/images/img5.png" alt=""> <span>КАЛЕНДАРЬ</span></a></li>
        </ul>
		<? endif; ?>
    </nav>
