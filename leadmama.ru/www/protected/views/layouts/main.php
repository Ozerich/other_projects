...
<div class="tab-block">
    ...
    <div class="page-block page-block-promo">
        <div class="width" id="home_promo">
            <div class="pic">
                <img src="images/pic-main.png" alt=""/>
            </div>
            <div class="text-block">
                <h2>Online-дневник</h2>

                <h3>развития вашего малыша</h3>
                <ul class="menu">
                    <li class="l1"><a href="/page/kormlenie"><img src="images/img01.gif" alt=""/> <em>Кормление</em></a></li>
                    <li class="l2"><a href="/page/galereya"><img src="images/img02.gif" alt=""/> <em>Фотогалерея</em></a></li>
                    <li class="l3"><a href="/page/dnevnik_instruction"><img src="images/img03.gif" alt=""/> <em>О малыше</em></a></li>
                    <li class="l4"><a href="/page/razvitiemalisha"><img src="images/img04.gif" alt=""/> <em>Рост малыша</em></a></li>
                </ul>
            </div>
        </div>
    </div>
