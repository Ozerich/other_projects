...
class NamesParser
{
    ...
    private function add($brand, $model, $spike, $is_winter, $alternative)
    {
        ...
        $q = 'INSERT INTO models (`brand`, `model`, `spike`, `is_winter`, `alternative`) VALUES ("' . $brand . '", "' . $model . '","' . (int)$spike . '","' . (int)$is_winter . '","' . $alternative . '")';
    ...
    public function parse($filename)
    {
        ...
        while (($data = fgetcsv($f, 1000, ';')) !== FALSE) {
            ...
            $this->add($brand, $model, $spike, $is_winter, $alternative);
        }
        fclose($f);
    }
}