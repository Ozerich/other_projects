...
<? $text = 'Ставка единого сельхозналога составляет 6 процентов от доходов, уменьшенных на величину расходов. Кроме того, налоговую базу можно уменьшить на сумму убытков. Доходы и расходы определяются кассовым методом. Порядок их учета установлен статьей 346.5 НК РФ.'?>
        ...
        <li>
            <div class="field-row">
                <div class="label">
                    ...
                    <input type="text" value="<?=v('step1_manual')?>" name="step1_manual" data-bind="value: step1_manual" class="custom-text"><span>руб.</span></div>
            </div>
            <!-- end_field-row -->
        </li>
        <li>
            ...
            <div class="calculation-block" style="display: <?=v('step1_is_manual') === 0 ? 'block' : 'none'?>">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="field"><input data-bind="value: var_1_1" name="var_1_1" value="<?=v('var_1_1')?>" type="text" class="custom-text"><span>руб.</span></div>
                        </td>
                    </tr>
                    <tr>
                        <td>Расходы, уменьшающие налоговую базу</td>
                        <td>
                            <div class="field"><input data-bind="value: var_1_2" name="var_1_2" value="<?=v('var_1_2')?>" type="text" class="custom-text"><span>руб.</span></div>
                        </td>
                    </tr>
                    <tr>
                        <td>Убытки прошлых лет, уменьшающие налоговую базу</td>
                        <td>
                            <div class="field"><input data-bind="value: var_1_3" name="var_1_3" value="<?=v('var_1_3')?>" type="text" class="custom-text"><span>руб.</span></div>
                        </td>
                    </tr>
                    <tr>
                        <td><b>База по ЕСХН</b></td>
...
<div class="calculation-total">
    <p>Общая сумма платежей в бюджет при уплате ЕСХН</p>
