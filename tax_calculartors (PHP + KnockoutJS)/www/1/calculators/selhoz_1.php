...
<? $text = 'С 1 января 2013 года нулевую ставку налога на прибыль вправе применять на постоянной основе сельскохозяйственные товаропроизводители и рыбохозяйственные организации, которые соответствуют условиям, предусмотренным статьей 346.2 НК РФ, и деятельность которых не облагается ЕСХН. Указанная льгота установлена для деятельности, связанной с реализацией произведенной, а также произведенной и переработанной такими налогоплательщиками собственной сельскохозяйственной продукции.
<br/><br/>В отношении иных видов деятельности применяется общеустановленная ставка налога на прибыль - 20 процентов'?>
...
<li class="step">
    ...
    <ul class="calculation-list">
        <li>
            <div class="field-row">
                <div class="label">
                    <input type="radio" name="is_step1_manual" class="hide" <?=isset($vars['is_step1_manual']) && $vars['is_step1_manual'] == 1 ? 'selected' : ''?> value="1" data-bind="checked: isNalogManual"><span>Указать</span>
                    <input type="text" data-bind="value: nalogManual" value="<?=isset($vars['step1_manual']) ? $vars['step1_manual'] : ''?>" name="step1_manual" class="custom-text"><span>руб.</span>
                </div>
        ...
        <li>
            <div class="field-row">
                <div class="label"><input type="radio" name="is_step1_manual" <?=isset($vars['is_step1_manual']) && $vars['is_step1_manual'] == 0 ? 'selected' : ''?> class="show" value="0" data-bind="checked: isNalogManual"><span>Рассчитать</span></div>
            </div>
            <!-- end_field-row -->
            <div class="calculation-block" style="display: <?=isset($vars['is_step1_manual']) && $vars['is_step1_manual'] == 0 ? 'block' : 'none'?>">
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="field">
                                <input type="text" name="var_1_1" value="<?=v('var_1_1')?>" data-bind="value: var_1_1" class="custom-text"><span>руб.</span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="field">
                                <input type="text" name="var_1_2" value="<?=v('var_1_2')?>" class="custom-text" data-bind="value: var_1_2" id="phoneNumber"><span>руб.</span>
                            </div>
                        </td>
                    </tr>
                    <tr>
...
<li class="step">
    ...
    <ul class="calculation-list">
        <li>
            <div class="field-row">
                <div class="label"><input type="radio" name="is_nds_need" <?=v('is_nds_need') === 0 ? 'selected' : ''?> value="0" data-bind="checked: nds_need" class="hide-nds"><span>Организация использует освобождение от уплаты НДС</span></div>
            </div>
            <!-- end_field-row -->
            <div id="nds_no_block" class="calculation-block"  style="display: <?=v('is_nds_need') === 0 ? 'block' : 'none'?>">
                <table>
                    <tr>
                        <td colspan="2"><b>Расчет</b></td>
                    </tr>
                    <tr>
                        <td>НДС, уплачиваемый организацией при импорте, в качестве налогового агента и иных ситуациях</td>
                        <td>
                            <div class="field"><input type="text" value="<?=v('nds_no_value')?>" name="nds_no_value" data-bind="value: nds_no_value" class="custom-text"><span>руб.</span></div>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <li>
            ...
            <!-- end_field-row -->
            <div id="nds_yes_block" class="calculation-row" style="display: <?=v('is_nds_need') == 1 ? 'block' : 'none'?>">
                <div class="field-row">
                    <div class="label"><input type="radio" name="is_nds_manual" <?=v('is_nds_manual') == 1 ? 'selected' : ''?> value="1" data-bind="checked: nds_is_manual" class="hide"><span>Указать</span>
                        <input type="text" data-bind="value: nds_manual" value="<?=v('nds_manual')?>" name="nds_manual" class="custom-text"><span>руб.</span></div>
                </div>
                <!-- end_field-row -->
                <div class="field-row">
                    <div class="label"><input type="radio" name="is_nds_manual" <?=v('is_nds_manual') === 0 ? 'selected' : ''?> value="0" data-bind="checked: nds_is_manual" class="show"><span>Рассчитать</span></div>
                </div>
                <!-- end_field-row -->
                <div class="calculation-block" style="display: <?=v('is_nds_manual') === 0 ? 'block' : 'none'?>">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="field"><input type="text" value="<?=v('var_2_1')?>" name="var_2_1" data-bind="value: var_2_1" class="custom-text"><span>руб.</span></div>
                            </td>
                        </tr>
                        <tr>
                            <td>НДС, начисленный с полученных авансов</td>
                            <td>
                                <div class="field"><input type="text" value="<?=v('var_2_2')?>" name="var_2_2" data-bind="value: var_2_2" class="custom-text"><span>руб.</span></div>
                            </td>
                        </tr>
                        <tr>
                            <td>НДС, уплачиваемый организацией при импорте, в качестве налогового агента и иных ситуациях</td>
                            <td>
                                <div class="field"><input type="text" value="<?=v('var_2_3')?>" name="var_2_3" data-bind="value: var_2_3" class="custom-text"><span>руб.</span></div>
                            </td>
                        </tr>
                        <tr>
                            <td>НДС, предъявленный с перечисленных авансов</td>
                            <td>
                                <div class="field"><input type="text" value="<?=v('var_2_4')?>" name="var_2_4" data-bind="value: var_2_4" class="custom-text"><span>руб.</span></div>
                            </td>
                        </tr>
                        <tr>
                            <td>НДС с полученных авансов, принимаемый к вычету при отгрузке товаров</td>
                            <td>
                                <div class="field"><input type="text" value="<?=v('var_2_5')?>" name="var_2_5" data-bind="value: var_2_5" class="custom-text"><span>руб.</span></div>
                            </td>
                        </tr>
                        <tr>
                            <td>Иные суммы НДС, принимаемые к вычету</td>
                            <td>
                                <div class="field"><input type="text" value="<?=v('var_2_6')?>" name="var_2_6" data-bind="value: var_2_6" class="custom-text"><span>руб.</span></div>
                            </td>
                        </tr>
                        <tr>
...
<li class="step">
    ...
    <ul class="calculation-list">
        <li>
            <div class="field-row">
                <div class="label"><input type="radio" name="is_step3_manual" value="1" <?=v('is_step3_manual') == 1 ? 'selected' : ''?> data-bind="checked: step3_is_manual" class="hide"><span>Указать</span>
                    <input type="text" data-bind="value: step3_manual" value="<?=v('step3_manual')?>" name="step3_manual" class="custom-text"><span>руб.</span></div>
            </div>
            <!-- end_field-row -->
        </li>
        <li>
            <div class="field-row">
                <div class="label"><input type="radio" name="is_step3_manual" value="0" <?=v('is_step3_manual') === 0 ? 'selected' : ''?> data-bind="checked: step3_is_manual" class="show"><span>Рассчитать</span></div>
            </div>
            <!-- end_field-row -->
            <div class="calculation-block" style="display: <?=v('is_step3_manual') === 0 ? 'block' : 'none'?>">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="field"><input type="text" name="var_3_1" value="<?=v('var_3_1');?>" data-bind="value: var_3_1" class="custom-text"><span>руб.</span></div>
                        </td>
                    </tr>
                    <tr>
                        <td>Ставка налога на имущество</td>
                        <td>
                            <div class="field"><input type="text" data-float="1" data-max="2.2" name="var_3_2" value="<?=v('var_3_2', 2.2);?>" data-bind="value: var_3_2" class="custom-text"><span>%</span></div>
                        </td>
                    </tr>
                    <tr>
        ...
        <li>
            ...
            <div class="calculation-block" style="display: <?=v('ins_is_manual') === 0 ? 'block' : 'none'?> ">
                <table>
                    ...
                    <tr>
                        <td>
                            <?= $type == 2 ? 'Сумма выплат в пользу физлиц, на которые начисляются страховые взносы, не превышающие предельную базу для начисления взносов' : 'Сумма выплат в пользу физлиц, на которые начисляются страховые взносы'?>
                        </td>
                        <td>
                    ...
                    <tr data-bind="visible: type == 2 && ins_c1()">
