...
<? $text = 'С 2013 года переход на «вмененку» носит добровольный характер, то есть, теперь компании вправе выбирать, применять этот спецрежим или нет. Поэтому если сельхозорганизация помимо основного вида деятельности занимается, к примеру, розничной торговлей товарами не собственного производства, она может уплачивать ЕНВД.
<br/><br/>Разумеется, речь идет о видах деятельности, подпадающих под «вмененку». Также предполагается, что сельхозорганизации вправе применять данный спецрежим и в городе или муниципальном районе введена система в виде ЕНВД.
<br/><br/>Калькулятор рассчитывает налог за год, то есть за 12 месяцев применения ЕНВД (за 4 квартала).
<br/><br/>Для корректного сравнения ЕНВД с иными режимами показатели по остальным режимам следует вводить только в отношении рассматриваемого вида деятельности.'?>
