function ViewModel(type) {
    ...
    this.ins_custom = ko.computed({
        'read':function () {
            ...
            var c1 = this.type == 1 ? false : that.ins_c1();

            if (!c1 && !that.ins_c2()) {
                res = v3 + v4 - v5 + v6 + v7 - v8;
            }
            else if (c1 && !that.ins_c2()) {
    ...
    this.prev_year_result = ko.computed(function () {
        ...
        if (!num(this.ins_is_manual())) {
            var var_3 = this._ins_var_2() * (this.type == 1 ? 0.16 : 0.22);
            var var_4 = this._ins_var_2() * (this.type == 1 ? 0.019 : 0.029);
            var var_6 = this._ins_var_2() * (this.type == 1 ? 0.023 : 0.051);
