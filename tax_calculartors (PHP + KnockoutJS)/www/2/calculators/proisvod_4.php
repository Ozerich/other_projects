...
<? $text = 'С 2013 года переход на «вмененку» носит добровольный характер, то есть, теперь предприятия вправе выбирать, применять этот спецрежим или нет. Поэтому если организация помимо основного вида деятельности занимается, к примеру, розничной торговлей покупными товарами, она может уплачивать ЕНВД.
<br/><br/>Разумеется, речь идет о видах деятельности, подпадающих под «вмененку». Также предполагается, что организация вправе применять данный спецрежим и в городе или муниципальном районе введена система в виде ЕНВД.
