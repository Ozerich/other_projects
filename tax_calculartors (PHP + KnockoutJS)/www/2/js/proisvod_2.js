function ViewModel(type) {
    ...
    this.var_1_5 = ko.computed(function () {
        return this.var_1_4() ? num(num(this.var_1_4()) * 0.15) : 0;
    }, this);

    this.var_1_6 = ko.computed(function () {
        return this.var_1_1() ? num(num(this.var_1_1()) * 0.01) : 0;
    }, this);

    this.step1_custom = ko.computed(function(){
        return Math.max(this.var_1_5(), this.var_1_6());
    }, this);
